...
public class Water implements Serializable {
	...
	public Water(Integer idPokemon, String nombre) {
		this.idPokemon = idPokemon;
		this.nombre = nombre;
	}

	public Water(String nombre, String img, String clase, String region, String categoria, Integer ataque,
				 Integer vida) {
		super();
		this.nombre = nombre;
		this.img = img;
    ...
    public Water buscarPorID(int i) {
        return null;
    }
